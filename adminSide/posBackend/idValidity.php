...
<html>
<head>
    <title>Check Reservation Validity</title>
    <!-- Add Bootstrap CSS -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <div class="container mt-5">
        <h2 class="text-center">Check Reservation Validity</h2>
        <form action="" method="post">
            ...
            <!-- <div class="form-group">
                <label for="accountid">Member ID:</label>
...
<div class="container mt-3">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $accountid = !empty($_POST['accountid']) ? $_POST['accountid'] : 1;
        ...
        if (!$result) {
            ...
            if ($staffExists && $memberExists && $reservationExists) {
                ...
                echo '</div>';
                echo '<div class="mt-3">';
                echo '<a href="posCashPayment.php?bill_id=' . $bill_id . '&staff_id=' . $staffId . '&account_id=' . $accountid . '&reservation_id=' . $reservationId . '" class="btn btn-success">Cash</a>';
                echo '<a href="posCardPayment.php?bill_id=' . $bill_id . '&staff_id=' . $staffId . '&account_id=' . $accountid . '&reservation_id=' . $reservationId . '" class="btn btn-primary ml-2">Credit Card</a>';
                echo '</div>';
            } else {
