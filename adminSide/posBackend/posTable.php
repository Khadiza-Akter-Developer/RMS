...
<?php
                ...
                if ($reservationResult) {
                    echo '<div class="row justify-content-center" style="margin-top: 3rem;">';
                    ...
                    while ($reservationRow = mysqli_fetch_assoc($reservationResult)) {
                        echo '<tr>';
                        echo '<td>' . $reservationRow['reservation_id'] . '</td>';
                        echo '<td>' . $reservationRow['customer_name'] . '</td>';
                        echo '<td>' . $reservationRow['table_id'] . '</td>';
                        echo '<td>' . $reservationRow['reservation_time'] . '</td>';
                        echo '<td>' . $reservationRow['reservation_date'] . '</td>';
                        echo '<td>' . $reservationRow['head_count'] . '</td>';
                        echo '<td>' . $reservationRow['special_request'] . '</td>';
                        echo '</tr>';
                    }
