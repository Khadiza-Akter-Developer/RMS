    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="" method="get">
                ...
                <!-- Add hidden input fields for bill_id, staff_id, account_id, and reservation_id -->
        ...
        if (isset($_GET['payment_amount'])) {
            ...
            if ($payment_amount >= $GRANDTOTAL) {
                ...
                $updateQuery = "UPDATE Bills SET payment_method = 'cash', payment_time = '$currentTime',
                                staff_id = $staff_id, account_id = $account_id, reservation_id = $reservation_id
                                WHERE bill_id = $bill_id;";
                
                // Update member points if account_id is not empty

   
                // $points = intval($GRANDTOTAL);
                // if ($link->query($updateQuery) === TRUE) {
                //     $update_points_sql = "UPDATE Memberships SET points = points + $points WHERE account_id = $account_id;";
